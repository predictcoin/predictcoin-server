...
export interface CrpWinnerPool extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  methods: {
    ...
    CRPPerBlock(): NonPayableTransactionObject<string>;
    ...
    initialize(
      _operator: string,
      _CRP: string,
      _CRPPerBlock: number | string | BN,
      _startBlock: number | string | BN,
      _maxCRPDeposit: number | string | BN,
      _wallet: string,
      _prediction: string
    ): NonPayableTransactionObject<void>;
    ...
    maxCRPDeposit(): NonPayableTransactionObject<string>;
